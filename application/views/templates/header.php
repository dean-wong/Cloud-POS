      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="<?= $title == 'Overview'?'active':'inactive' ?>"><a href="<?= base_url('index.php/pos/overview')?>">
              <span class="glyphicon glyphicon-th" aria-hidden="true"></span> 餐桌</a>
            </li>
            <li class="<?= $title == 'Order'?'active':'inactive' ?>"><a href="<?= base_url('index.php/pos/order')?>">
              <span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> 点菜</a>
            </li >
            <li class="<?= $title == 'Cashier'?'active':'inactive' ?>"><a href="<?= base_url('index.php/pos/cashier')?>">
